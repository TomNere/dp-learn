    ...
    public render() {
        ...
        return (
            <div>
                ...
                <ul>
                    <li><BoldLink href={strings.tree.theory.matrixMultHref}>{strings.tree.theory.matrixMultTitle}</BoldLink></li>
                    <li><BoldLink href={strings.tree.theory.rnaHref}>{strings.tree.theory.rnaTitle}</BoldLink></li>
                </ul>
            </div>
        );
    }
